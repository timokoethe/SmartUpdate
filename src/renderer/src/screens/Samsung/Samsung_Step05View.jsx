...
import Samsung_DE_05 from '../../assets/phones/Samsung_DE_05.mp4'
import Samsung_EN_05 from '../../assets/phones/Samsung_EN_05.mp4'

function Samsung_Step05View() {
  ...
  return (
    <>
      ...
      <div className='topAlign spacer px-100'>
        ...
        <video ref={videoRef} className='phoneGraphic mt-100' src={loc.languageKey == 'de' ? Samsung_DE_05 : Samsung_EN_05 } loop />
...
export default Samsung_Step05View